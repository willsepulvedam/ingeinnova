...
class Emprendimiento(SQLModel, table=True):
    ...
    descripcion: str = Field(..., description="Descripción del emprendimiento", max_length=500)
    fecha_creacion: datetime = Field(default_factory=datetime.now)
    estado: EstadoEmprendimiento  = Field(default=EstadoEmprendimiento.INACTIVO, description="Estado del emprendimiento")